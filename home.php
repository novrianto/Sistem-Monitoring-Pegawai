  ...
  <div class="col-md-8">
    <div class="card card-outline card-success">
      <div class="card-header">
        <b>Project yang sedang dijalankan</b>
      </div>
        ...
        <div class="table-responsive">
          <table class="table m-0 table-hover">
            ...
            <tbody>
              <?php
              $i = 1;
              $stat = array("Pending", "Mulai", "Sedang Berjalan", "Tertahan", "Tenggat Waktu", "Selesai");
              $where = "";
              if ($_SESSION['login_type'] == 2) {
                $where = " where manager_id = '{$_SESSION['login_id']}' ";
              } elseif ($_SESSION['login_type'] == 3) {
              ...
              ?>
                <tr>
                  ...
                  <td class="project-state">
                    ...
                    } elseif ($stat[$row['status']] == 'Sedang Berjalan') {
                      echo "<span class='badge badge-info'>{$stat[$row['status']]}</span>";
                    } elseif ($stat[$row['status']] == 'Tertahan') {
                      echo "<span class='badge badge-warning'>{$stat[$row['status']]}</span>";
                    } elseif ($stat[$row['status']] == 'Tenggat Waktu') {
