	...
	<div class="card card-outline card-primary">
			...
			<form action="" id="manage-project">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="status" id="status" class="custom-select custom-select-sm">
								...
								<option value="3" <?php echo isset($status) && $status == 3 ? 'selected' : '' ?>>Tertahan</option>
								<option value="3" <?php echo isset($status) && $status == 3 ? 'selected' : '' ?>>Sedang Berjalan</option>
				...
				<div class="row">
					<?php if ($_SESSION['login_type'] == 1) : ?>
						<div class="col-md-6">
							<div class="form-group">
								<label for="" class="control-label">Manager Project</label>
				...
				<div class="row">
					<div class="col-md-10">
						<div class="form-group">
							<label for="" class="control-label">Deskripsi Project</label>
		...
		<div class="card-footer border-top border-info">
			<div class="d-flex w-100 justify-content-center align-items-center">
				...
				<button class="btn btn-flat bg-gradient-secondary mx-2" type="button" onclick="location.href='index.php?page=project_list'">Kembali</button>
			</div>
		</div>
	</div>
</div>
